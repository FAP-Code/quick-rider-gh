...
export function generateShirt(input: EngineInput): EngineOutput {
  ...
  const backPiece: PatternPiece = {
    ...
    keyMeasurements: [`Chest: ${chest}cm`, `Length: ${shirtLength}cm`],
  }
  ...
  const frontPiece: PatternPiece = {
    ...
    keyMeasurements: [`Chest: ${chest}cm`, `Neck: ${neckCirc}cm`],
  }
  ...
  const sleevePiece: PatternPiece = {
    ...
    notches: [edgeNotch(sleeveOutline.points, 0, 90), edgeNotch(sleeveOutline.points, 4, -90)],
  ...
  const collarOutline: PatternPath = {
    isClosed: true,
    isSeamLine: false,
    points: [
      { x: 0, y: 0 },
  ...
  const collarPiece: PatternPiece = {
    ...
    seamLine: buildSeamLine(collarOutline, sa),
    foldLine: {
      isClosed: false, isFoldLine: true,
